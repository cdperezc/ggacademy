...
export function LearningHero() {
  return (
    <section 
      className="relative min-h-[600px] flex items-center justify-center bg-gradient-primary overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <h1 className="text-4xl md:text-6xl font-inter font-bold text-white mb-6 tracking-[-0.03em] leading-tight">
          GpsGate Learning Center
        </h1>
        <p className="text-xl md:text-2xl text-gps-off-white mb-8 max-w-3xl mx-auto leading-relaxed">
          Get to know your fleet better with comprehensive tutorials, guides, and hands-on training
        </p>
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="relative">
            <Input
              ...
              className="h-14 pl-12 pr-4 text-lg bg-white/95 border-0 shadow-gps-accent placeholder:text-gps-middle-grey"
            />
